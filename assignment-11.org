...
*** Answer 11
    *Discussion:* First, observe that flooring on the left side guarantees
...
*** Answer 12
    *Discussion:* One way to see why this statement is true, is to observe that
    ...
    *Proof:* First, I will restate the problem more formally to allow
...
*** Answer 13
    *Discussion:* The proof relies on the axiom of completeness of real numbers
    ...
    *Proof:* The textbook has a proof of density property of $\mathbb{R}$, which
...
*** Answer 14
    *Discussion:* I am not sure whether the question has any deeper meaning,
    ...
    *Proof:* As discussed above, let $x=1.5$ and $y=2$. 1 is the maximal element
